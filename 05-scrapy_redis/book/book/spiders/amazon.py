...
class AmazonSpider(RedisCrawlSpider):
    ...
    rules = (
        # 匹配大分类的url地址
        Rule(LinkExtractor(
            restrict_xpaths=("//ul[@class='a-unordered-list a-nostyle a-vertical s-ref-indent-one']/div/li")),follow=True),
        # 匹配小分类的url地址
        Rule(LinkExtractor(
            restrict_xpaths=("//ul[@class='a-unordered-list a-nostyle a-vertical s-ref-indent-two']/div/li")),follow=True),
        # 匹配图书的url地址
